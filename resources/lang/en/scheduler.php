...
return [
    ...
    'stale_columns_title' => 'Report columns need updating',
    'stale_columns_body' => 'None of the columns chosen for this report exist any more. Edit the report, remove the old ones from <strong>Columns to include in report</strong>, and add them again from <strong>Available Columns</strong>. Then try again.',
    'partly_stale_columns_title' => 'Some columns were left out',
    'partly_stale_columns_body' => 'These columns no longer exist and were left out: :columns. Edit the report, remove them from <strong>Columns to include in report</strong>, and add them again from <strong>Available Columns</strong>.',
