...
return [
    ...
    'summary_daily' => 'Daily at :time',
    'summary_weekly' => 'Weekly on :day at :time',
    'summary_monthly' => 'Monthly on day :day at :time',
    'summary_monthly_last_day' => 'Monthly on the last day at :time',
    'summary_periodic' => ':frequency from :month :day at :time',
    'summary_cron' => 'Cron :expression',
    'summary_disabled' => ':summary (disabled)',
    'recipient' => 'Recipient',
    'last_run' => 'Last Run',
    ...
    'schedule_output' => 'File Format',
    'schedule_output_description' => 'The file format this schedule produces.',
    'format' => 'File Format',
    ...
    'download_stale_columns_title' => 'Report columns need updating',
    'download_stale_columns_body' => 'None of the columns chosen for this report exist any more. Edit the report, remove the old ones from <strong>Columns to include in report</strong>, and add them again from <strong>Available Columns</strong>. Then download it.',
    'download_partly_stale_columns_title' => 'Some columns were left out',
    'download_partly_stale_columns_body' => 'These columns no longer exist and are not in the download: :columns. Edit the report, remove them from <strong>Columns to include in report</strong>, and add them again from <strong>Available Columns</strong>.',
